...
class HotelServiceTest {
    ...
    public class HotelQuery{
        ...
        void when_queryAllColumns_return_specificData() {
            ...
            List<String> attrList = Arrays.asList(HotelDao.ATTR_ID,HotelDao.ATTR_NAME,HotelDao.ATTR_STREET,HotelDao.ATTR_CITY,HotelDao.ATTR_CP,HotelDao.ATTR_STATE,
            		HotelDao.ATTR_COUNTRY,HotelDao.ATTR_PHONE,HotelDao.ATTR_PHONE,HotelDao.ATTR_EMAIL,HotelDao.ATTR_DESCRIPTION,HotelDao.ATTR_IS_OPEN);
        ...
        public EntityResult getAllHotelsData() {
            List<String> columnList = Arrays.asList(HotelDao.ATTR_ID,HotelDao.ATTR_NAME,HotelDao.ATTR_STREET,HotelDao.ATTR_CITY,HotelDao.ATTR_CP,HotelDao.ATTR_STATE,
            		HotelDao.ATTR_COUNTRY,HotelDao.ATTR_PHONE,HotelDao.ATTR_PHONE,HotelDao.ATTR_EMAIL,HotelDao.ATTR_DESCRIPTION,HotelDao.ATTR_IS_OPEN);
    ...
    public class InsertQuery{
		...
		void when_unable_insert() {
			...
			EntityResult entityResult = service.hotelInsert(attrMap);
			assertEquals(EntityResult.OPERATION_WRONG, entityResult.getCode());
    		assertEquals(entityResult.getMessage(), ErrorMessage.CREATION_ERROR+"El campo " + HotelDao.ATTR_NAME + " es nulo");
    	}
    }
