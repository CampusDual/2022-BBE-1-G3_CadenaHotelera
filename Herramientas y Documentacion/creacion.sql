...
CREATE TABLE answers(
	nsw_id INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,
	nsw_qst_id INTEGER,
	htl_id int4,	
	nsw_user varchar(50),
	nsw_cst_id INTEGER,
	FOREIGN KEY(nsw_qst_id) REFERENCES questions(qst_id),
	FOREIGN KEY(nsw_cst_id) REFERENCES customers(cst_id),
	FOREIGN KEY(nsw_user) REFERENCES tuser(user_)
);

--DROP TABLE answers_valoration;
CREATE TABLE answers_valoration(
	nsv_id INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,	
	points int2,	
	nsv_user varchar(50),
	nsv_nsw_id INTEGER NO null,
	FOREIGN KEY(nsw_id) REFERENCES answers_valoration(nsv_id),
	FOREIGN KEY(nsv_user) REFERENCES tuser(user_)
);
