...
public interface IRoomService {
	...
	public boolean isRoomUnbookedgInRange(String startDate, String endDate, Integer roomId) throws OntimizeJEERuntimeException, EntityResultRequiredException, InvalidFieldsValuesException, MissingFieldsException;
